...
# Kotlin: descarga el compilador oficial y descomprímelo en /opt
curl -sL https://github.com/JetBrains/kotlin/releases/latest/download/kotlin-compiler.zip -o /tmp/kotlinc.zip
sudo unzip -q /tmp/kotlinc.zip -d /opt        # crea /opt/kotlinc

# Swift (toolchain oficial de swift.org para tu distro; ejemplo Ubuntu)
# Descarga el tarball correcto desde https://www.swift.org/install/linux/
sudo mkdir -p /opt/swift
curl -sL <URL-del-tarball-swift> | sudo tar xz -C /opt/swift --strip-components=1
```
