...
import accesoWikiRoutes from './routes/acceso-wiki.routes.js';
import categoriasGrupoRoutes from './routes/categorias-grupo.routes.js';
...
import escenariosRoutes from './routes/escenarios.routes.js';
...
app.use('/api', accesoWikiRoutes);
app.use('/api', categoriasGrupoRoutes);
